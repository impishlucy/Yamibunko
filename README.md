...
Yamibunko is a local anime library server with a desktop launcher and a web UI. <br/> It processes your files, organizes them into a library, enriches entries with metadata, and plays them through the browser.
